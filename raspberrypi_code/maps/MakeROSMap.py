...
file_name = 'asb9000lv_binary.png'
...
#
    image[iy,ix]=(0,0,255)
    cv2.line(image,(ix+2,iy),(ix+1,iy),(0,0,255),1)
    cv2.line(image,(ix-2,iy),(ix-1,iy),(0,0,255),1)
    cv2.line(image,(ix,iy+2),(ix,iy+1),(0,0,255),1)
    cv2.line(image,(ix,iy-2),(ix,iy-1),(0,0,255),1)
#
...
#
    if x1[0] == 0:
      ...
      mapLocation = '/home/CapstoneB/raspberrypi_code/maps/'
      completeFileNameMap = 'asb9000lv.pgm'
      completeFileNameYaml = 'asb9000lv.yaml'
