...
if __name__ == "__main__":
    ...
    while not rospy.is_shutdown():
        ...
        # ultrasonic_l_link -> base
        broadcaster.sendTransform(*make_transform([0, 0.2000, 0.024, 0, 0, 1.5708]), current_time, "ultrasonic_l_link", "base_link")
        # ultrasonic_r_link -> base
        broadcaster.sendTransform(*make_transform([0, -0.2000, 0.024, 0, 0, 4.7124]), current_time, "ultrasonic_r_link", "base_link")
        # ultrasonic_b_link -> base
        broadcaster.sendTransform(*make_transform([-0.216, 0, 0.024, 0, 0, 3.1416]), current_time, "ultrasonic_b_link", "base_link")
        rate.sleep()
